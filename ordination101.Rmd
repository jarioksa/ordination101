...
- **Plots** will not move and all other permutations is within them

- **Blocks** of SUs can be permuted with other blocks

- SUs within Plots and Blocks can be permuted freely, as
  unidimensional series or as spatial grids

- Series and grids can be mirrorred: Mirrorring makes sense for
  spatial grids, but not often for time series

- Permutations can be similar within all Plots and Blocks
