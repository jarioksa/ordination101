...
.pull-right[
```{r pcacorr, fig.width=5}
mod1 <- rda(varespec, scale=TRUE)
palette(viridis(8))
par(mar=c(4,4,1,1)+.1)
plot(mod1, scaling="sites")
```
]
---
class:  inverse center middle
