...
- We use external variables, and we can test their significance
...
- Use a linear combination of constraints as the explanatory
...
- **Forward selection:** variables are added as long as they improve
    the model with all previously selected variables

- Similar to sequential tests for terms

- Aluminum was the first choice: it correlates with many other
  variables and this makes it a good surrogate
...
- Aluminum was one of the first dropped: it correlates with many other
