...
- PCA explains the **variance** of the data: the squared
  ...
  - NB., ordination always centres data so that species means $\bar y = 0$
  
  - The total variance (sum of species variance) is called **inertia**
...
- In the origin, all species occurs at their average abundances
...
- LC scores really are linear combinations of constraints, and when
  projected onto biplot arrows, they fall on the values of constraints
